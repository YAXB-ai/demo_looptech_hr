...
from rag.indexing.colbert import rag_colbert_save
from rag.indexing.Chromadb import rag_chroma_save,rag_chroma_load
# print(rag_chroma_load().invoke("I received a gift from a supplier and am not sure if I can accept it. What should I do?"))

pages=rag_pdf_loader("./assets/LOOPTECH-HR Policy Looptech demo2.pdf")
format_data=""
print(len(pages))
